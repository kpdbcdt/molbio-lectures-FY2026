"""Generate QR code PNGs for Lec08 poll questions.
...
BASE_URL = "https://kpdbcdt.github.io/molbio-lectures-FY2026/lec08/poll/student.html"
OUT_DIR = os.path.dirname(os.path.abspath(__file__))

QUESTIONS = {
    1: ("S04", "EcoRI の由来"),
    2: ("S14", "PCR 30 サイクルの増幅倍率"),
    3: ("S28", "CRISPR の KO 修復経路"),
}
...
def make_labeled(qnum, slide, question_text, qr_img):
    ...
    draw.text((40, 30), "分子生物学 LEC 08 · Slide " + slide, font=f_lec, fill="white")
...
def make_lab_qr_slide():
    """Generate a QR code slide pointing to the main Lec08 Interactive Lab."""
    url = "https://kpdbcdt.github.io/molbio-lectures-FY2026/lec08/"
    qr_img = make_qr(url)
    W, H = 1200, 1200
    canvas = Image.new("RGB", (W, H), "white")
    draw = ImageDraw.Draw(canvas)
    ...
    draw.text((50, 35), "分子生物学 LEC 08 — 講義後の復習", font=f_lec, fill="white")
    ...
    out = os.path.join(OUT_DIR, "qr_lec08_lab_slide.png")
    canvas.save(out)
