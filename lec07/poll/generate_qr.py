...
BASE_URL = "https://kpdbcdt.github.io/molbio-lectures-FY2026/lec07/poll/student.html"
...
def make_labeled(qnum, slide, question_text, qr_img):
    ...
    draw.text((40, 30), "分子生物学 LEC 07 · Slide " + slide, font=f_lec, fill="white")
...
def make_lab_qr_slide():
    """Generate a QR code slide pointing to the main Lec07 Interactive Lab."""
    url = "https://kpdbcdt.github.io/molbio-lectures-FY2026/lec07/"
    qr_img = make_qr(url)
    W, H = 1200, 1200
    canvas = Image.new("RGB", (W, H), "white")
    draw = ImageDraw.Draw(canvas)
    ...
    draw.text((50, 35), "分子生物学 LEC 07 — 講義後の復習", font=f_lec, fill="white")
    ...
    out = os.path.join(OUT_DIR, "qr_lec07_lab_slide.png")
    canvas.save(out)
